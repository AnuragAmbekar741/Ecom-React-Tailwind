...
const About = () => {
  return (
    <section>
        <div className='w-full gird md:flex px-20 py-10 mb-20'>
            <div className='grid w-full  md:w-2/6 mt-10 md:justify-start md:text-left'>
                <h1 className='text-[150px] leading-[150px] lg:text-[170px] lg:leading-[100px] tracking-widest font-thin'>Who</h1>
                <h1 className='text-[150px] leading-[150px] lg:text-[170px] lg:leading-[100px] tracking-widest font-thin'>We</h1>
                <h1 className='text-[150px] leading-[150px] lg:text-[170px] lg:leading-[100px] tracking-widest font-thin'>Are?</h1>
            </div>
            <div className='w-4/6'>
            <div className='w-full  justify-center mt-10 md:-mt-8 md:text-left'>
                <h1 className='text-[38px] md:my-2 tracking-widest font-light'>ABOUT THE BRAND</h1>
                <h3 className='text-[19px] my-3 font-light '>
            ...
            <div className='w-full justify-end text-left md:text-left'>
                <h1 className='text-[38px] md:mb-1 tracking-wider font-light mt-7'>ABOUT THE DESIGNER</h1>
