        ...
        <div className='w-full  flex px-20 py-10 mb-20'>
            ...
            <div className='w-3/6 justify-center -mt-8'>
                ...
                <h3 className='text-[21px] my-3 font-light tracking-wide p-1 leading-9 pr-12'>
                   ...
                   <span   className='font-medium hover:font-medium transition delay-100 scale-125'>Creating looks that don't just 'work' but
                   TREND!</span><br/>
            ...
            <div className='w-1/6 justify-end text-right'>
                ...
                <h3 className='text-[16px] font-light  p-1 pl-3'>The creator of this passion project is Rhea Vania De Quadros. She hails from Goa, India. Currently based in Mumbai, Rhea has worked for various brands, celebrities and assisted the top stylist in the industry!</h3>
            </div>
        </div>
    </section>
  )
